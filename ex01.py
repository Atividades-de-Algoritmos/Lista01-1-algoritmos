...
# algoritmo são apresentadas em tela. Sabendo disso, desenvolva um programa em linguagem Python que
# solicite do usuário o seu nome e apresente em tela um cabeçalho padrão, seguido pelo nome informado,
...
# processamento
print('**************************************')
print('* ALGORTIMOS E LÓGICA DE PROGRAMAÇÃO *')
print('* Turma: 1° INTIN   Ano letivo: 2022 *')
